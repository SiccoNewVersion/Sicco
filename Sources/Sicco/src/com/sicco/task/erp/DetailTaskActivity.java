...
public class DetailTaskActivity extends ChooseFileActivity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.lnDateFinish:
			...
			break;
		case R.id.lnHandler:
			new DialogChooseHandler(DetailTaskActivity.this, listDep, allUser,
					listCheckedHandler);
			break;
		case R.id.lnViewer:
			ActionAdapter.flag = "chooseViewer";
			new DialogChooseUser(DetailTaskActivity.this, listDep, allUser,
					listChecked);
			break;
		case R.id.lnDepartment:
			new DialogChooseDepartment(DetailTaskActivity.this, listDep);
			break;
		case R.id.lnFile:
			showFileChooser();
			break;
		case R.id.lnProject:
			new DialogChooseProject(DetailTaskActivity.this, listProject);
			break;
		case R.id.btnAssign:
