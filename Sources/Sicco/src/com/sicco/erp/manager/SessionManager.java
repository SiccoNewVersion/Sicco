...
public class SessionManager {
	...
	private static final String PREF_NAME = "sicco_pref";
	 ...
	 * */
	public void createLoginSession(String name, String pass, String user_id, String id_phong_ban) {
	...
	public HashMap<String, String> getUserDetails() {
		...
		user.put(KEY_ID_PHONGBAN, pref.getString(KEY_ID_PHONGBAN, null));
		return user;
	}
